...
## [#](https://xiaolincoding.com/mysql/base/row_format.html#mysql-的数据存放在哪个文件)MySQL 的数据存放在哪个文件？
...
### [#](https://xiaolincoding.com/mysql/base/row_format.html#表空间文件的结构是怎么样的)表空间文件的结构是怎么样的？
...
## [#](https://xiaolincoding.com/mysql/base/row_format.html#innodb-行格式有哪些)InnoDB 行格式有哪些？
...
## [#](https://xiaolincoding.com/mysql/base/row_format.html#varchar-n-中-n-最大取值为多少)varchar(n) 中 n 最大取值为多少？
